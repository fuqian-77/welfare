	...
	function myCreateGridRows(pmyGrid1,n0,n){ //新增一行rrrrrrr
		...
		for (var i=n0; i<n0+n; i++){
			...
			for (var j=0; j<pmyGrid1.columns.length; j++){
				...
				str2='<div id="'+id+'"  onclick="pmyGrid1=myCellFocus(pmyGrid1,'+row+','+j+')" class="textgrid" style="position:absolute; text-align:'+align+'; padding:0px 2px 0px 6px; line-height:'+(pmyGrid1.rowheight*1)+'px; height:'+(pmyGrid1.rowheight)+'px; width:'+(w)+'px; top:'+(top)+'px; left:'+(left)+'px;"></div>\n';
